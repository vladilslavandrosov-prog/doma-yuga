...
- Галерея (/cabinet/project/:id/gallery): все фото позиций сметы, сгруппированные по workGroup. Фильтрация по группе. Lightbox для просмотра. Админ может загружать/удалять фото
