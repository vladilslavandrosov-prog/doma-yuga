...
export async function seedDatabase() {
  ...
  await db.insert(users).values([
    { id: 1, username: "admin", password: await hashPassword("admin123"), role: "admin", clientId: null },
    { id: 2, username: "client", password: await hashPassword("client123"), role: "client", clientId: 1 },
    { id: 3, username: "petrov", password: await hashPassword("petrov123"), role: "client", clientId: 2 },
  ]);
