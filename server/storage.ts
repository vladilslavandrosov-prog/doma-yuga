import {
  ...
  type ClientReminder, type InsertClientReminder, type ReminderHistory,
} from "@shared/schema";
...
export interface IStorage {
  ...
  getEstimatesByProjectIds(projectIds: number[]): Promise<Estimate[]>;
  ...
  getPaymentsByProjectIds(projectIds: number[]): Promise<Payment[]>;
  ...
  resolveClientReminderIfPending(id: number, data: Partial<InsertClientReminder>): Promise<ClientReminder | undefined>;
